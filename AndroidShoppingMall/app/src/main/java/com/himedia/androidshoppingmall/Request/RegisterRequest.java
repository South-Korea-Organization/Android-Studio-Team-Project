...
public class RegisterRequest extends StringRequest {
    ...
    //final static private String URL = "http://3.37.214.236/android_001/Register.php";   //실서버
    private static final String URL ="http://gdkgate.dothome.co.kr/android_001/Register.php";
